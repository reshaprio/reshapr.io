...
reShapr components are packaged as four independently versioned Helm charts. This page describes baseline `0.0.14`; the [`reshapr-helm-charts`](https://github.com/reshaprio/reshapr-helm-charts) repository owns installation commands, values, and release artifacts.
