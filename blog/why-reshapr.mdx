...
> 1. Use the [**Try it Online**](https://try.reshapr.io) option to explore the platform. Follow our detailed ["Try reShapr online"](https://reshapr.io/docs/tutorials/try-reshapr-online).
> 2. Or Run the platform locally using containers, check out the [“Run using Docker Compose”](https://reshapr.io/docs/how-to-guides/docker-compose/).
