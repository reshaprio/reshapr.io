# reShapr AI Contribution Policy

Contributors may use Generative AI tools (such as Large Language Models, GitHub Copilot, Cursor, Claude Code, etc.) when contributing to reShapr. As with any development tool, you are responsible for the quality of the result and for understanding what you submit.

This policy applies to all repositories in the `reshaprio` GitHub organization.

## Guiding Principle

reShapr is a community-driven open source project that values expertise, clear communication, and personal responsibility. To maintain trust in the AI era, we follow a key principle:
...
As reShapr moves toward joining the Agentic AI Foundation (AAIF), a directed fund of the Linux Foundation, contributions should also comply with the [Linux Foundation Generative AI Policy](https://www.linuxfoundation.org/legal/generative-ai).
...
This policy is adapted from the [Microcks AI Contribution Policy](https://github.com/microcks/.github/blob/main/AI-POLICY.md), which was itself inspired by the [Crossplane AI Contribution Policy](https://github.com/crossplane/crossplane/blob/main/AI_POLICY.md) and by the collaborative [CNCF discussion on AI contribution policies](https://github.com/cncf/foundation/issues/1285) initiated by Microcks.
